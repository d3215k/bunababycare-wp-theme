	...
	<div id="content" class="flex-grow site-content">
		...
		<?php if ( is_front_page() ) { ?>
			...
			<div class="container pb-12 mx-auto my-12 border-b">
				<h1 class="text-lg font-bold text-pink-600">Bunababycare</h1>
				<h2 class="my-4 text-3xl font-extrabold tracking-tight lg:text-7xl">Let's build something great!.</h2>
