...
<?php do_action( 'bunababycare_content_after' ); ?>
		...
		<footer id="colophon" class="py-12 site-footer" role="contentinfo">
			...
			<div class="container flex flex-col items-center mx-auto space-y-2 text-center text-gray-600">
				<img width="200" class="mb-2" src="<?php echo bunababycare_asset('images/logo.svg') ?>" alt="Logo Bunababycare">
