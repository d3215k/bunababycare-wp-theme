        ...
        <div class="py-2">
            <div class="flex snap-x scroll-pl-4 gap-2 space-x-4 overflow-x-auto px-8 py-2 sm:scroll-pl-6 sm:space-x-8 md:scroll-pl-[calc(50%-20rem)] lg:scroll-pl-[calc(50%-25rem)]">
                <div class="flex-none w-64 snap-start">
                    <img src="<?php echo bunababycare_asset('images/testimonials/1.jpg') ?>" />
                </div>
                <div class="flex-none w-64 snap-start">
                    <img src="<?php echo bunababycare_asset('images/testimonials/2.jpg') ?>" />
                </div>
                <div class="flex-none w-64 snap-start">
                    <img src="<?php echo bunababycare_asset('images/testimonials/3.jpg') ?>" />
                </div>
                <div class="flex-none w-64 snap-start">
                    <img src="<?php echo bunababycare_asset('images/testimonials/4.jpg') ?>" />
                </div>
                <div class="flex-none w-64 snap-start">
                    <img src="<?php echo bunababycare_asset('images/testimonials/5.jpg') ?>" />
                </div>
                <div class="flex-none w-64 snap-start">
                    <img src="<?php echo bunababycare_asset('images/testimonials/6.jpg') ?>" />
                </div>
                <div class="flex-none w-64 snap-start">
                    <img src="<?php echo bunababycare_asset('images/testimonials/7.jpg') ?>" />
                </div>
                <div class="flex-none w-64 snap-start">
                    <img src="<?php echo bunababycare_asset('images/testimonials/8.jpg') ?>" />
                </div>
                <div class="flex-none w-64 snap-start">
                    <img src="<?php echo bunababycare_asset('images/testimonials/9.jpg') ?>" />
                </div>
                <div class="flex-none w-64 snap-start">
                    <img src="<?php echo bunababycare_asset('images/testimonials/10.jpg') ?>" />
                </div>
            </div>
        </div>
    </div>
